...
/////////////////
const BotName = '☄RakhA☄'; 
const instagram = 'TIDAK ADA'; 
const telegram = 'TIDAK ADA'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'TIDAK ADA';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('BOT BY : RAKHA MHDZZ')
